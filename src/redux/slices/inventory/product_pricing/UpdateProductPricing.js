...
export const updateProductPricingTodo = createAsyncThunk('updateProductPricing', async (data) => {
    let user = ''
    ...
    try {
        const res = await axios({
            ...
            method: 'POST',
            url: process.env.REACT_APP_API_URL + 'product-pricings',
            data: {
                ...
                "productPricingDTOList": product_price
            },
